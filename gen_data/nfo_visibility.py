...
# formula further. seq1/seq4: column-min method, tighter margin. seq2: original column-mean
# result plus a manually-confirmed third corridor at ~73% horizontal (a real gap next to a
# diagonal branch against the background wall, missed by every automated width threshold
# tried). seq3: original column-mean result, unchanged throughout.
